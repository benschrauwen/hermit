...
prompt_catalog:
  ...
  engineering-roadmap:
    scope: role
    file: 20-mode-roadmap.md
  engineering-people:
    scope: role
    file: 21-mode-people.md
  engineering-delivery:
    scope: role
    file: 22-mode-delivery.md
  engineering-incident:
    scope: role
    file: 23-mode-incident.md
  engineering-system:
    scope: role
    file: 24-mode-system.md
  engineering-standard:
    scope: role
    file: 25-role-engineering.md
  engineering-agentic-delivery:
    scope: role
    file: 26-mode-agentic-delivery.md
  engineering-ticket:
    scope: role
    file: 27-mode-ticket.md
required_prompts:
  - core-soul
  - file-rules
  - bootstrap
