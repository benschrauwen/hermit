...
- Ask user-focused questions only when they help the current task or resolve a risky ambiguity.
...
- Keep unknowns explicit, separate facts from assumptions, and keep `source_refs` current.
